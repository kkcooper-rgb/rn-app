  ...
  render() {
    ...
    return (
      <View>
        ...
        <View>
          {
            cartData.detailData&&cartData.detailData.length&&cartData.detailData.map((item,index)=>{
              return <View style={styles.goodsItem} key={index}>
                <View style={styles.goodsItemLeft}>
                  <View style={{width:100,height:80}}>
                    <Image style={{width:100,height:80}} source={{url:item.goods_small_logo ||defaultPic}}></Image>
                  </View>
                </View>
                <View style={styles.goodsItemRight}>
                  ...
                  <View style={styles.goodsInfoBox}>
                    <View >
                      {/* <Text style={{fontSize:16,color:'#c00000'}}>￥{item.goods_price }</Text> */}
                    </View>
                  </View>
                </View>
              </View>
